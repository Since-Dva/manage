  ...
  <div class="autoPartsDetail">
        ...
        <div class="left1">
          ...
          <div class="left1_2">
            <div class="left1_2_1">
              <div>
                <span>入驻品牌：</span>
                <span>{{base.value1}}</span>
              </div>
              <div>
                <span>创建人：</span>
                <span>{{base.value2}}</span>
              </div>
              <div>
                <span>合作状态：</span>
                <span>{{base.value3}}</span>
              </div>
            </div>
            <div class="left1_2_2">
              <div>
              <span>入驻类型：</span>
              <span>{{base.value4}}</span>
            </div>
            <div>
              <span>创建时间：</span>
              <span>{{base.value5}}</span>
            </div>
            </div>
            <div>
              <span>所在地区：</span>
              <span>{{base.value6}}</span>
            </div>
            <div>
              <span>详细地址：</span>
              <span>{{base.value7}}</span>
            </div>
          </div>
        </div>
        <div class="left2">
    ...
    <el-dialog custom-class="basic" title="修改基本信息" :visible.sync="basicModal" width="580.992px">
      ...
      <div class="dyrow">
        ...
        <div class="select sel-200">
          <el-select v-model="base.select4">
            <el-option
              v-for="item in []"
              :key="item.value"
              :label="item.label"
      ...
      <div class="dyrow">
        ...
        <div class="select sel-200">
          <el-select v-model="base.select5">
            <el-option
              v-for="item in []"
              :key="item.value"
              :label="item.label"
    ...
    <!-- 编辑合同信息 -->
    <el-dialog title="编辑合同信息" custom-class="contract" :visible.sync="contractModal" width="580.992px">
      <span>合同：</span>
      <el-upload
        class="upload-demo"
    ...
    data() {
      return {
        ...
        base: {
          ...
          value3:'合作中',
          value4:'外观件、底盘件、常用件',
          value5:'2020/7/30/   16:43',
          value6:'重庆 - 重庆 - 渝北 拷贝',
          value7:'重庆市渝北区仙桃数据谷C16-A2-2层',
          select1: null,
          select2: null,
          select3: null,
        },
      ...
      .right {
        ...
        .right1 {
          ...
          .triangle {
            width: 0;
            height: 0;
            border-top: 107.002px solid #3498db;
            border-left: 107.002px solid transparent;
            position: absolute;
            right: 0;
            top: 0;
            &::after {
